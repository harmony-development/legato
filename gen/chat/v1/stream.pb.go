...
type StreamEvent struct {
	...
	//	*StreamEvent_InviteCreated_
	//	*StreamEvent_InviteDeleted_
	//	*StreamEvent_InviteUsed_
	//	*StreamEvent_NewReactionAdded_
	//	*StreamEvent_ReactionAdded_
	//	*StreamEvent_ReactionRemoved_
...
func (x *StreamEvent) GetInviteCreated() *StreamEvent_InviteCreated {
	if x, ok := x.GetEvent().(*StreamEvent_InviteCreated_); ok {
		return x.InviteCreated
	}
	return nil
}

func (x *StreamEvent) GetInviteDeleted() *StreamEvent_InviteDeleted {
	if x, ok := x.GetEvent().(*StreamEvent_InviteDeleted_); ok {
		return x.InviteDeleted
	}
	return nil
}

func (x *StreamEvent) GetInviteUsed() *StreamEvent_InviteUsed {
	if x, ok := x.GetEvent().(*StreamEvent_InviteUsed_); ok {
		return x.InviteUsed
	}
	return nil
}
...
func (x *StreamEvent) GetNewReactionAdded() *StreamEvent_NewReactionAdded {
	if x, ok := x.GetEvent().(*StreamEvent_NewReactionAdded_); ok {
		return x.NewReactionAdded
	}
	return nil
}

func (x *StreamEvent) GetReactionAdded() *StreamEvent_ReactionAdded {
	if x, ok := x.GetEvent().(*StreamEvent_ReactionAdded_); ok {
...
func (x *StreamEvent) GetReactionRemoved() *StreamEvent_ReactionRemoved {
	if x, ok := x.GetEvent().(*StreamEvent_ReactionRemoved_); ok {
...
type StreamEvent_OwnerAdded_ struct {
	...
	OwnerAdded *StreamEvent_OwnerAdded `protobuf:"bytes,26,opt,name=owner_added,json=ownerAdded,proto3,oneof"`
}

type StreamEvent_OwnerRemoved_ struct {
	// Send the owner removed event.
	OwnerRemoved *StreamEvent_OwnerRemoved `protobuf:"bytes,27,opt,name=owner_removed,json=ownerRemoved,proto3,oneof"`
}

type StreamEvent_InviteReceived_ struct {
	// Send the guild invite received event.
	InviteReceived *StreamEvent_InviteReceived `protobuf:"bytes,28,opt,name=invite_received,json=inviteReceived,proto3,oneof"`
}

type StreamEvent_InviteRejected_ struct {
	// Send the guild invite rejected event.
	InviteRejected *StreamEvent_InviteRejected `protobuf:"bytes,29,opt,name=invite_rejected,json=inviteRejected,proto3,oneof"`
}

type StreamEvent_InviteCreated_ struct {
	// Send the invite created event.
	InviteCreated *StreamEvent_InviteCreated `protobuf:"bytes,30,opt,name=invite_created,json=inviteCreated,proto3,oneof"`
}

type StreamEvent_InviteDeleted_ struct {
	// Send the invite deleted event.
	InviteDeleted *StreamEvent_InviteDeleted `protobuf:"bytes,31,opt,name=invite_deleted,json=inviteDeleted,proto3,oneof"`
}

type StreamEvent_InviteUsed_ struct {
	// Send the invite used event.
	InviteUsed *StreamEvent_InviteUsed `protobuf:"bytes,32,opt,name=invite_used,json=inviteUsed,proto3,oneof"`
}

type StreamEvent_NewReactionAdded_ struct {
	// Send the new reaction added event.
	NewReactionAdded *StreamEvent_NewReactionAdded `protobuf:"bytes,33,opt,name=new_reaction_added,json=newReactionAdded,proto3,oneof"`
}

type StreamEvent_ReactionAdded_ struct {
	// Send the reaction added event.
	ReactionAdded *StreamEvent_ReactionAdded `protobuf:"bytes,34,opt,name=reaction_added,json=reactionAdded,proto3,oneof"`
}

type StreamEvent_ReactionRemoved_ struct {
	// Send the reaction removed event.
	ReactionRemoved *StreamEvent_ReactionRemoved `protobuf:"bytes,35,opt,name=reaction_removed,json=reactionRemoved,proto3,oneof"`
}
...
func (*StreamEvent_InviteCreated_) isStreamEvent_Event() {}

func (*StreamEvent_InviteDeleted_) isStreamEvent_Event() {}

func (*StreamEvent_InviteUsed_) isStreamEvent_Event() {}

func (*StreamEvent_NewReactionAdded_) isStreamEvent_Event() {}

func (*StreamEvent_ReactionAdded_) isStreamEvent_Event() {}

func (*StreamEvent_ReactionRemoved_) isStreamEvent_Event() {}
...
type StreamEvent_MessageUpdated struct {
	...
	// New message content.
	NewContent *Content `protobuf:"bytes,5,opt,name=new_content,json=newContent,proto3" json:"new_content,omitempty"`
}
...
type StreamEvent_NewReactionAdded struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StreamEvent_NewReactionAdded) Reset() {
	*x = StreamEvent_NewReactionAdded{}
	if protoimpl.UnsafeEnabled {
...
// Should only be sent to users who have the "message.view" permission for
// the guild channel where the reaction was added.
type StreamEvent_ReactionAdded struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StreamEvent_InviteReceived) Reset() {
	*x = StreamEvent_InviteReceived{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chat_v1_stream_proto_msgTypes[37]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamEvent_InviteReceived) Descriptor() ([]byte, []int) {
	return file_chat_v1_stream_proto_rawDescGZIP(), []int{2, 30}
}
...
func (x *StreamEvent_InviteRejected) Reset() {
	*x = StreamEvent_InviteRejected{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chat_v1_stream_proto_msgTypes[38]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamEvent_InviteRejected) Descriptor() ([]byte, []int) {
	return file_chat_v1_stream_proto_rawDescGZIP(), []int{2, 31}
}
...
type StreamEvent_InviteCreated struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StreamEvent_InviteCreated) Reset() {
	*x = StreamEvent_InviteCreated{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chat_v1_stream_proto_msgTypes[39]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamEvent_InviteCreated) Descriptor() ([]byte, []int) {
	return file_chat_v1_stream_proto_rawDescGZIP(), []int{2, 32}
}
...
//
// This will only be sent to members of a guild with "invites.view" permission.
type StreamEvent_InviteDeleted struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StreamEvent_InviteDeleted) Reset() {
	*x = StreamEvent_InviteDeleted{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chat_v1_stream_proto_msgTypes[40]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamEvent_InviteDeleted) Descriptor() ([]byte, []int) {
	return file_chat_v1_stream_proto_rawDescGZIP(), []int{2, 33}
}
...
//
// This will only be sent to members of a guild with "invites.view" permission.
type StreamEvent_InviteUsed struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StreamEvent_InviteUsed) Reset() {
	*x = StreamEvent_InviteUsed{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chat_v1_stream_proto_msgTypes[41]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreamEvent_InviteUsed) Descriptor() ([]byte, []int) {
	return file_chat_v1_stream_proto_rawDescGZIP(), []int{2, 34}
}
...
var file_chat_v1_stream_proto_rawDesc = []byte{
	...
	0xca, 0x3c, 0x0a, 0x0b, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12,
	...
	,
	...
	,
	...
	0x12, 0x33, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x65, 0x63, 0x68, 0x6f, 0x5f, 0x69,
	0x64, 0x1a, 0xc2, 0x01, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x55, 0x70, 0x64,
	...
	0x09, 0x65, 0x64, 0x69, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04,
	0x52, 0x08, 0x65, 0x64, 0x69, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x3a, 0x0a, 0x0b, 0x6e, 0x65,
	...
	0x76, 0x31, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x52, 0x0a, 0x6e, 0x65, 0x77, 0x43,
	0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x1a, 0x69, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x67, 0x75, 0x69, 0x6c,
	...
	0x64, 0x1a, 0xa7, 0x02, 0x0a, 0x0e, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x67, 0x75, 0x69, 0x6c, 0x64, 0x5f, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x67, 0x75, 0x69, 0x6c, 0x64, 0x49, 0x64, 0x12,
	0x1d, 0x0a, 0x0a, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x09, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x49, 0x64, 0x12, 0x12,
	0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61,
	0x6d, 0x65, 0x12, 0x42, 0x0a, 0x08, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04,
	...
	0x49, 0x74, 0x65, 0x6d, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x08, 0x70, 0x6f,
	0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x31, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x18, 0x05,
	...
	0xbe, 0x01, 0x0a, 0x0f, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x65, 0x72, 0x66, 0x6f, 0x72,
	...
	0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x39, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f,
	...
	0x1a, 0x9d, 0x01, 0x0a, 0x0b, 0x52, 0x6f, 0x6c, 0x65, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64,
	...
	,
	...
	0x64, 0x88, 0x01, 0x01, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18,
	...
	0x6e, 0x65, 0x77, 0x50, 0x65, 0x72, 0x6d, 0x73, 0x42, 0x0d, 0x0a, 0x0b, 0x5f, 0x63, 0x68, 0x61,
	0x6e, 0x6e, 0x65, 0x6c, 0x5f, 0x69, 0x64, 0x1a, 0x68, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x52,
	0x6f, 0x6c, 0x65, 0x73, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x67,
	0x75, 0x69, 0x6c, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x67,
	...
	0x20, 0x0a, 0x0c, 0x6e, 0x65, 0x77, 0x5f, 0x72, 0x6f, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x73, 0x18,
	0x03, 0x20, 0x03, 0x28, 0x04, 0x52, 0x0a, 0x6e, 0x65, 0x77, 0x52, 0x6f, 0x6c, 0x65, 0x49, 0x64,
	0x73, 0x1a, 0x5b, 0x0a, 0x06, 0x54, 0x79, 0x70, 0x69, 0x6e, 0x67, 0x12, 0x17, 0x0a, 0x07, 0x75,
	...
	0x01, 0x28, 0x04, 0x52, 0x09, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x49, 0x64, 0x1a, 0x87,
	0x01, 0x0a, 0x11, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x67, 0x75, 0x69, 0x6c, 0x64, 0x5f, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x67, 0x75, 0x69, 0x6c, 0x64, 0x49, 0x64, 0x12,
	...
	0x88, 0x01, 0x01, 0x12, 0x14, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x6f, 0x6b, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x02, 0x6f, 0x6b, 0x42, 0x0d, 0x0a, 0x0b, 0x5f, 0x63, 0x68,
	0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x5f, 0x69, 0x64, 0x1a, 0x68, 0x0a, 0x0d, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x50, 0x69, 0x6e, 0x6e, 0x65, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x67, 0x75, 0x69,
	...
	0x49, 0x64, 0x1a, 0x6a, 0x0a, 0x0f, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x55, 0x6e, 0x70,
	...
	,
	...
	,
	...
	0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x1a, 0x6c, 0x0a,
	0x0d, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x12, 0x19,
	0x0a, 0x08, 0x67, 0x75, 0x69, 0x6c, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04,
	0x52, 0x07, 0x67, 0x75, 0x69, 0x6c, 0x64, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x69, 0x6e, 0x76,
	...
	,
	...
	0x72, 0x49, 0x64, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x42, 0xbf, 0x01, 0x0a,
...
var file_chat_v1_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_chat_v1_stream_proto_goTypes = []interface{}{
	...
	(*StreamEvent_NewReactionAdded)(nil),                    // 32: protocol.chat.v1.StreamEvent.NewReactionAdded
	(*StreamEvent_ReactionAdded)(nil),                       // 33: protocol.chat.v1.StreamEvent.ReactionAdded
	(*StreamEvent_ReactionRemoved)(nil),                     // 34: protocol.chat.v1.StreamEvent.ReactionRemoved
	(*StreamEvent_OwnerAdded)(nil),                          // 35: protocol.chat.v1.StreamEvent.OwnerAdded
	(*StreamEvent_OwnerRemoved)(nil),                        // 36: protocol.chat.v1.StreamEvent.OwnerRemoved
	(*StreamEvent_InviteReceived)(nil),                      // 37: protocol.chat.v1.StreamEvent.InviteReceived
	(*StreamEvent_InviteRejected)(nil),                      // 38: protocol.chat.v1.StreamEvent.InviteRejected
	(*StreamEvent_InviteCreated)(nil),                       // 39: protocol.chat.v1.StreamEvent.InviteCreated
	(*StreamEvent_InviteDeleted)(nil),                       // 40: protocol.chat.v1.StreamEvent.InviteDeleted
	(*StreamEvent_InviteUsed)(nil),                          // 41: protocol.chat.v1.StreamEvent.InviteUsed
	(*v1.StreamEvent)(nil),                                  // 42: protocol.emote.v1.StreamEvent
	(*v11.StreamEvent)(nil),                                 // 43: protocol.profile.v1.StreamEvent
	(*Message)(nil),                                         // 44: protocol.chat.v1.Message
	(*Content)(nil),                                         // 45: protocol.chat.v1.Content
	(*v12.ItemPosition)(nil),                                // 46: protocol.harmonytypes.v1.ItemPosition
	(ChannelKind)(0),                                        // 47: protocol.chat.v1.ChannelKind
	(*v12.Metadata)(nil),                                    // 48: protocol.harmonytypes.v1.Metadata
	(LeaveReason)(0),                                        // 49: protocol.chat.v1.LeaveReason
	(*ActionPayload)(nil),                                   // 50: protocol.chat.v1.ActionPayload
	(*Permission)(nil),                                      // 51: protocol.chat.v1.Permission
	(*Reaction)(nil),                                        // 52: protocol.chat.v1.Reaction
}
var file_chat_v1_stream_proto_depIdxs = []int32{
	...
	42, // 5: protocol.chat.v1.StreamEventsResponse.emote:type_name -> protocol.emote.v1.StreamEvent
	43, // 6: protocol.chat.v1.StreamEventsResponse.profile:type_name -> protocol.profile.v1.StreamEvent
	...
	35, // 32: protocol.chat.v1.StreamEvent.owner_added:type_name -> protocol.chat.v1.StreamEvent.OwnerAdded
	36, // 33: protocol.chat.v1.StreamEvent.owner_removed:type_name -> protocol.chat.v1.StreamEvent.OwnerRemoved
	37, // 34: protocol.chat.v1.StreamEvent.invite_received:type_name -> protocol.chat.v1.StreamEvent.InviteReceived
	38, // 35: protocol.chat.v1.StreamEvent.invite_rejected:type_name -> protocol.chat.v1.StreamEvent.InviteRejected
	39, // 36: protocol.chat.v1.StreamEvent.invite_created:type_name -> protocol.chat.v1.StreamEvent.InviteCreated
	40, // 37: protocol.chat.v1.StreamEvent.invite_deleted:type_name -> protocol.chat.v1.StreamEvent.InviteDeleted
	41, // 38: protocol.chat.v1.StreamEvent.invite_used:type_name -> protocol.chat.v1.StreamEvent.InviteUsed
	32, // 39: protocol.chat.v1.StreamEvent.new_reaction_added:type_name -> protocol.chat.v1.StreamEvent.NewReactionAdded
	33, // 40: protocol.chat.v1.StreamEvent.reaction_added:type_name -> protocol.chat.v1.StreamEvent.ReactionAdded
	34, // 41: protocol.chat.v1.StreamEvent.reaction_removed:type_name -> protocol.chat.v1.StreamEvent.ReactionRemoved
	44, // 42: protocol.chat.v1.StreamEvent.MessageSent.message:type_name -> protocol.chat.v1.Message
	45, // 43: protocol.chat.v1.StreamEvent.MessageUpdated.new_content:type_name -> protocol.chat.v1.Content
	46, // 44: protocol.chat.v1.StreamEvent.ChannelCreated.position:type_name -> protocol.harmonytypes.v1.ItemPosition
	47, // 45: protocol.chat.v1.StreamEvent.ChannelCreated.kind:type_name -> protocol.chat.v1.ChannelKind
	48, // 46: protocol.chat.v1.StreamEvent.ChannelCreated.metadata:type_name -> protocol.harmonytypes.v1.Metadata
	48, // 47: protocol.chat.v1.StreamEvent.ChannelUpdated.new_metadata:type_name -> protocol.harmonytypes.v1.Metadata
	46, // 48: protocol.chat.v1.StreamEvent.ChannelPositionUpdated.new_position:type_name -> protocol.harmonytypes.v1.ItemPosition
	48, // 49: protocol.chat.v1.StreamEvent.GuildUpdated.new_metadata:type_name -> protocol.harmonytypes.v1.Metadata
	49, // 50: protocol.chat.v1.StreamEvent.MemberLeft.leave_reason:type_name -> protocol.chat.v1.LeaveReason
	50, // 51: protocol.chat.v1.StreamEvent.ActionPerformed.payload:type_name -> protocol.chat.v1.ActionPayload
	46, // 52: protocol.chat.v1.StreamEvent.RoleMoved.new_position:type_name -> protocol.harmonytypes.v1.ItemPosition
	51, // 53: protocol.chat.v1.StreamEvent.RolePermissionsUpdated.new_perms:type_name -> protocol.chat.v1.Permission
	52, // 54: protocol.chat.v1.StreamEvent.NewReactionAdded.reaction:type_name -> protocol.chat.v1.Reaction
...
func file_chat_v1_stream_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_chat_v1_stream_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamEvent_NewReactionAdded); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chat_v1_stream_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamEvent_ReactionAdded); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chat_v1_stream_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamEvent_ReactionRemoved); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chat_v1_stream_proto_msgTypes[37].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chat_v1_stream_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chat_v1_stream_proto_msgTypes[39].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamEvent_InviteCreated); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chat_v1_stream_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamEvent_InviteDeleted); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chat_v1_stream_proto_msgTypes[41].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamEvent_InviteUsed); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_chat_v1_stream_proto_msgTypes[2].OneofWrappers = []interface{}{
		...
		(*StreamEvent_InviteCreated_)(nil),
		(*StreamEvent_InviteDeleted_)(nil),
		(*StreamEvent_InviteUsed_)(nil),
		(*StreamEvent_NewReactionAdded_)(nil),
		(*StreamEvent_ReactionAdded_)(nil),
		(*StreamEvent_ReactionRemoved_)(nil),
	}
	...
	file_chat_v1_stream_proto_msgTypes[37].OneofWrappers = []interface{}{}
	type x struct{}
